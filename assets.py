...
DEEPSEEK_MODEL_FULLNAME ="deepseek-coder-6.7b-instruct" # Example, adjust if different

MODELS_USED = {
    OPENAI_MODEL_FULLNAME: {"OPENAI_API_KEY"},
    GEMINI_MODEL_FULLNAME: {"GEMINI_API_KEY"},
    DEEPSEEK_MODEL_FULLNAME : {"GROQ_API_KEY"}, # Ensure this matches your model provider for Deepseek
}
